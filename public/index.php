...
<div class="text-center max-w-xl mx-auto mt-16 min-h-[71.5vh] flex items-center justify-center flex-col">
    <h1 class="text-4xl font-bold mb-6 text-indigo-700 mt-[-5vh]">Bienvenue sur PlanningCo</h1>
    <p class="text-lg mb-8 text-gray-700">
        Simplifiez la gestion des plannings de vos employ&eacute;s avec notre outil intuitif.
    </p>
