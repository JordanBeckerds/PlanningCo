...
<div class="max-w-5xl mx-auto mt-8 p-4 sm:p-6 bg-white rounded shadow">
            ...
            ?>
                <div class="flex items-center justify-center gap-2">
                    <a href="?view=month&year=<?= $prevYear ?>&month=<?= $prevMonth ?>" 
                        aria-label="Mois précédent" class="text-xs md:text-base min-w-[35%] md:min-w-[6vw] flex items-center justify-center">
                        &laquo; Précédent
                    </a>
                    ...
                    <a href="?view=month&year=<?= $nextYear ?>&month=<?= $nextMonth ?>" 
                        aria-label="Mois suivant" class="text-xs md:text-base min-w-[35%] md:min-w-[6vw] flex items-center justify-center">
                        Suivant &raquo;
                    </a>
                </div>
